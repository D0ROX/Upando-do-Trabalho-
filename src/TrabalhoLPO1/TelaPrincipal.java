...
public class TelaPrincipal extends JFrame {
    ...
    private void abrirTelaClientes() {
        TelaClientes tela = new TelaClientes(banco);
        tela.setVisible(true);
    }

    private void abrirTelaVincularConta() {
        TelaVincularConta tela = new TelaVincularConta(banco);
        tela.setVisible(true);
    }

    private void abrirTelaManipularConta() {
        TelaManipularConta tela = new TelaManipularConta(banco);
        tela.setVisible(true);
    }
