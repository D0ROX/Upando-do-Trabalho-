...
public class TelaVincularConta extends JFrame {
    ...
    public TelaVincularConta(GerenciadorBanco banco) {
        this.banco = banco;
    ...
    private void criarConta() {
        ...
        try {
            ...
            if ("Conta Corrente".equals(tipoConta)) {
                ...
                novaConta = new ContaCorrente(clienteSelecionado, depositoInicial, limite);
            } else {
                double depositoInicial = Double.parseDouble(txtDepositoInicial.getText());
                ...
                novaConta = new ContaInvestimento(clienteSelecionado, depositoInicial,
